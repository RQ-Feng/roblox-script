...
local EmbeddedModules = {
        ...
        Explorer.SearchFilters = { -- TODO: Use data table (so we can disable some if funcs don't exist)
            Comparison = {
                ["isa"] = function(argString)
                    ...
                    local classQuery = argString:split()[1]
    ...
    return search]==]
        ...
        Explorer.UpdateSelectionVisuals = function()
            ...
            -- Updates theme
            for _, v in ipairs(Explorer.SelectionVisualGui:GetChildren()) do
            ...
            local function renderSide(side, noTween) -- TODO: Use existing resizers
                ...
                for i, v in ipairs(side.Windows) do
                    ...
                    if noTween then
                        ...
                        local tween =
                            service.TweenService:Create(v.GuiElems.Main, sideTweenInfo, { Size = size, Position = pos })
                        tweens[#tweens + 1] = tween
                        tween:Play()
                    end
                    currentPos = currentPos + v.SizeY + 4
        ...
        Lib.ContextMenu = (function()
            ...
            funcs.AddDivider = function(self, text)
                ...
                local textWidth = text
                        and service.TextService:GetTextSize(text, 14, Enum.Font.SourceSans, Vector2.new(999999999, 20)).X
                    or nil
    ...
    local function main()
        ...
        Properties.SoundPreviewProp =
            { Category = "Data", ValueType = { Name = "SoundPlayer" }, Class = "Sound", Name = "Preview", Tags = {} }
