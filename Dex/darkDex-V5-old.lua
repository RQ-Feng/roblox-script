...
local contentR = gui:WaitForChild("ContentFrame")
...
local function welcomePlayer()
    ...
    welcomeFrame:TweenPosition(UDim2.new(0.5, -250, 0, -400), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.5,
        true)
    wait(0.5)
